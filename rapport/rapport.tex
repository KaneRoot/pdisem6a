...
\fancyhead[C]{Programmation Distribuée $\bullet$ decembre 2012} % Custom header text
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Programmation Distribuée}} % Article title

\author{
\large
\textsc{Philippe PITTOLI - Claude HEMBERGER}\\[2mm] % Your name
\normalsize University of Strasbourg \\ % Your institution
\normalsize \href{mailto:philippe.pittoli@etu.unistra.fr}{nous contacter} % Your email address
\vspace{-5mm}
}
\date{}
